...
const PremiumDetails = () => {
  const { setpremiumDetails, setenabledPaymentSection , detailsToggle, setdetailsToggle} = useContext(MyContext);
  ...
  return (
    <div className="relative flex justify-center w-full   z-20 ">
      <div className="sm:pb-[75px] fixed bg-white max-w-[900px] w-full dropShadow mt-[10px]">
        ...
        <p className="Montserrat400 sm:text-[16px] text-[14px] font-[400] leading-normal text-[#474747] text-center sm:mt-[20px] mt-[27px]">
          Verify your account with Verbyo and <br className="block sm:hidden" />{" "}
          demonstrate that you are a real person.
          <br />
